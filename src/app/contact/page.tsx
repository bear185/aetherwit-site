        ...
        >
          ...
          <form className="space-y-6 flex flex-col" onSubmit={(e) => e.preventDefault()}>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="mt-6 flex items-center justify-center gap-3 bg-[var(--foreground)] text-[var(--background)] font-mono px-8 py-4 rounded-sm tracking-widest uppercase text-sm hover:bg-[var(--color-silicon)] hover:text-white transition-colors"
            >
              <Send className="w-4 h-4" />
              <span className="font-bold">Transmit Signal</span>
            </motion.button>
          </form>
        </motion.div>
      </div>
